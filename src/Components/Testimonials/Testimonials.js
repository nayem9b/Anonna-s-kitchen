          ...
          <div class='flex flex-wrap -m-4'>
            <div class='p-4 md:w-1/2 w-full'>
              <div class='h-full bg-gray-100 p-8 rounded'>
                ...
                <p class='leading-relaxed mb-6'>
                  ...
                  is the best cook in our town. And her dishes prices are
                  reasonable and heartwarming to eat. I tend to order food from
                  her very often
                </p>
            ...
            <div class='p-4 md:w-1/2 w-full'>
              <div class='h-full bg-gray-100 p-8 rounded'>
                ...
                <p class='leading-relaxed mb-6'>
                  Apu onek valo ranna kore. Ami prayoi order dei. Tar hater
                  Chicken roast ranna ta sobcheye joss
                  <span className='text-orange-400 text-xl font-bold italic mr-1 ml-2'>
                    Anonna
                  </span>
                  {"    "}
                  apu er dish gulor dam o reasonable
                </p>
                <a class='inline-flex items-center'>
                  <div className='avatar'>
                    <div className='w-12 rounded-full'>
